function miFuncion(){
  ...
  .then(data => {
    //Defino y concateno vars
      ...
      marker.bindPopup("Aqui vive el random user.").openPopup();

    //Fetch a la api de RickAndMorty, ya realizado en tp2. Solo cambio el data1
    var idpj=Math.floor(Math.random() * 826) + 1;
    ...
    } else if (sexo2 == "genderless") {
      document.getElementById("mensaje2").style.backgroundColor = "grey";
    } else if (sexo2 == "unknown") {
      document.getElementById("mensaje2").style.backgroundColor = "white";
    } 
